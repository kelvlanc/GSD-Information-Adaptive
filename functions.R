...
calculateCorrectionTerm = function(data, 
  ...
  if(estimationMethod==tmle){
    ...
    p=dim(model.matrix(outcome_formulas[[3]], data))[2]
...
interimAnalysis = function(data, 
  ...
  list(estimateOriginal, standardErrorOriginal, testStatisticOriginal, 
       decisionOriginal, informationTimeOriginal, estimateUpdated, 
       standardErrorUpdated, testStatisticUpdated, 
       decisionUpdated, informationTimeUpdated, covMatrixOriginal) 
